...
export const calGetcAreas: GeArea[] = [
  { id: "1A", name: "English Composition", required_units: 3, applies_to: ['UC', 'CSU'], provenance: CAL_GETC_SOURCE },
  { id: "1B", name: "Critical Thinking / Composition", required_units: 3, applies_to: ['UC', 'CSU'], provenance: CAL_GETC_SOURCE },
  // CSU only: a UC-bound student must not be told to solve this.
  { id: "1C", name: "Oral Communication", required_units: 3, applies_to: ['CSU'], provenance: CAL_GETC_SOURCE },
  { id: "2", name: "Mathematical Concepts & Quantitative Reasoning", required_units: 3, applies_to: ['UC', 'CSU'], provenance: CAL_GETC_SOURCE },
  { id: "3A", name: "Arts", required_units: 3, applies_to: ['UC', 'CSU'], provenance: CAL_GETC_SOURCE },
  { id: "3B", name: "Humanities", required_units: 3, applies_to: ['UC', 'CSU'], provenance: CAL_GETC_SOURCE },
